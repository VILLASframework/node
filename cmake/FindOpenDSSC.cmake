...
find_library(OPENDSS_LIBRARY_DIR
    NAMES OpenDSSC
    PATH_SUFFIXES bin/openDSS
)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(OpenDSSC DEFAULT_MSG OPENDSS_LIBRARY_DIR OPENDSSC_INCLUDE_DIR)
...
if(OpenDSSC_FOUND)
    ...
    set_target_properties(OpenDSSC PROPERTIES
        IMPORTED_LOCATION "${OPENDSS_LIBRARY_DIR}"
