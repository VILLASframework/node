 ...
 */
#ifndef RTW_HEADER_send_receive_1_sm_model_h_
#define RTW_HEADER_send_receive_1_sm_model_h_
#ifndef send_receive_1_sm_model_COMMON_INCLUDES_
# define send_receive_1_sm_model_COMMON_INCLUDES_
#include <stddef.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* send_receive_1_sm_model_COMMON_INCLUDES_ */

#include "send_receive_1_sm_model_types.h"
...
#define send_receive_1_sm_model_rtModel RT_MODEL_send_receive_1_sm_model
...
typedef struct {
  ...
  real_T Sum;                          /* '<S1>/Sum' */
  real_T dataready2kHz;                /* '<S2>/data ready 2 kHz' */
...
} BlockIO_send_receive_1_sm_model;
...
typedef struct {
  ...
  int32_T clockTickCounter;            /* '<S2>/data ready 2 kHz' */
  int32_T clockTickCounter_h;          /* '<S2>/Pulse Generator1' */
  int_T SFunction_IWORK[5];            /* '<S7>/S-Function' */
} D_Work_send_receive_1_sm_model;

/* Backward compatible GRT Identifiers */
#define rtB                            send_receive_1_sm_model_B
#define BlockIO                        BlockIO_send_receive_1_sm_model
#define rtXdot                         send_receive_1_sm_model_Xdot
#define StateDerivatives               StateDerivatives_send_receive_1_sm_model
#define tXdis                          send_receive_1_sm_model_Xdis
#define StateDisabled                  StateDisabled_send_receive_1_sm_model
#define rtP                            send_receive_1_sm_model_P
#define Parameters                     Parameters_send_receive_1_sm_model
#define rtDWork                        send_receive_1_sm_model_DWork
#define D_Work                         D_Work_send_receive_1_sm_model

/* Parameters (auto storage) */
struct Parameters_send_receive_1_sm_model_ {
  ...
  real_T SFunction_X0;                 /* Expression: 0
                                        ...
                                        */
  real_T dataready2kHz_Amp;            /* Expression: 1
                                        * Referenced by: '<S2>/data ready 2 kHz'
                                        */
  real_T dataready2kHz_Period;         /* Expression: 10
                                        * Referenced by: '<S2>/data ready 2 kHz'
                                        */
  real_T dataready2kHz_Duty;           /* Expression: 1
                                        * Referenced by: '<S2>/data ready 2 kHz'
                                        */
  real_T dataready2kHz_PhaseDelay;     /* Expression: 0
                                        * Referenced by: '<S2>/data ready 2 kHz'
                                        */
  real_T Constant_Value[4];            /* Expression: [1 2 3 4]
                                        * Referenced by: '<S2>/Constant'
                                        */
  real_T PulseGenerator1_Amp;          /* Expression: 5
...
struct RT_MODEL_send_receive_1_sm_model {
  const char_T *path;
...
extern Parameters_send_receive_1_sm_model send_receive_1_sm_model_P;

/* Block signals (auto storage) */
extern BlockIO_send_receive_1_sm_model send_receive_1_sm_model_B;

/* Block states (auto storage) */
extern D_Work_send_receive_1_sm_model send_receive_1_sm_model_DWork;

/* Real-time Model object */
extern struct RT_MODEL_send_receive_1_sm_model *const send_receive_1_sm_model_M;
 ...
 *
 * '<Root>' : 'send_receive_1_sm_model'
 * '<S1>'   : 'send_receive_1_sm_model/OpCCode_do_not_touch'
 * '<S2>'   : 'send_receive_1_sm_model/sm_model'
 * '<S3>'   : 'send_receive_1_sm_model/sm_model/receive message 1'
 * '<S4>'   : 'send_receive_1_sm_model/sm_model/rtlab_send_subsystem'
 * '<S5>'   : 'send_receive_1_sm_model/sm_model/send message 1'
 * '<S6>'   : 'send_receive_1_sm_model/sm_model/rtlab_send_subsystem/Subsystem1'
 * '<S7>'   : 'send_receive_1_sm_model/sm_model/rtlab_send_subsystem/Subsystem1/Send1'
 */
#endif                                 /* RTW_HEADER_send_receive_1_sm_model_h_ */
