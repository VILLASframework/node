...
#define send_receive_1_sm_model_rtModel RT_MODEL_send_receive_1_sm_model_T
...
typedef struct {
  ...
  int32_T clockTickCounter_b;          /* '<S2>/Pulse Generator' */
  int_T SFunction_IWORK[5];            /* '<S7>/S-Function' */
} DW_send_receive_1_sm_model_T;

/* Backward compatible GRT Identifiers */
#define rtB                            send_receive_1_sm_model_B
#define BlockIO                        B_send_receive_1_sm_model_T
#define rtP                            send_receive_1_sm_model_P
#define Parameters                     P_send_receive_1_sm_model_T
#define rtDWork                        send_receive_1_sm_model_DW
#define D_Work                         DW_send_receive_1_sm_model_T

/* Parameters (auto storage) */
struct P_send_receive_1_sm_model_T_ {
...
struct tag_RTM_send_receive_1_sm_model_T {
  const char_T *path;
...
extern P_send_receive_1_sm_model_T send_receive_1_sm_model_P;

/* Block signals (auto storage) */
extern B_send_receive_1_sm_model_T send_receive_1_sm_model_B;

/* Block states (auto storage) */
extern DW_send_receive_1_sm_model_T send_receive_1_sm_model_DW;

/* Real-time Model object */
extern RT_MODEL_send_receive_1_sm_model_T *const send_receive_1_sm_model_M;
