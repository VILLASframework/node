...
B_send_receive_1_sm_model_T send_receive_1_sm_model_B;

/* Block states (auto storage) */
DW_send_receive_1_sm_model_T send_receive_1_sm_model_DW;

/* Real-time model */
RT_MODEL_send_receive_1_sm_model_T send_receive_1_sm_model_M_;
RT_MODEL_send_receive_1_sm_model_T *const send_receive_1_sm_model_M =
  &send_receive_1_sm_model_M_;

/* Model output function */
static void send_receive_1_sm_model_output(void)
{
  /* Memory: '<S1>/S-Function' */
  send_receive_1_sm_model_B.SFunction =
    send_receive_1_sm_model_DW.SFunction_PreviousInput;
  ...
  send_receive_1_sm_model_B.dataready2kHz =
    (send_receive_1_sm_model_DW.clockTickCounter <
     send_receive_1_sm_model_P.dataready2kHz_Duty) &&
    (send_receive_1_sm_model_DW.clockTickCounter >= 0) ?
    send_receive_1_sm_model_P.dataready2kHz_Amp : 0.0;
  if (send_receive_1_sm_model_DW.clockTickCounter >=
  ...
  send_receive_1_sm_model_B.PulseGenerator =
    (send_receive_1_sm_model_DW.clockTickCounter_b <
     send_receive_1_sm_model_P.PulseGenerator_Duty) &&
    (send_receive_1_sm_model_DW.clockTickCounter_b >= 0) ?
    send_receive_1_sm_model_P.PulseGenerator_Amp : 0.0;
  if (send_receive_1_sm_model_DW.clockTickCounter_b >=
      send_receive_1_sm_model_P.PulseGenerator_Period - 1.0) {
    send_receive_1_sm_model_DW.clockTickCounter_b = 0;
  } else {
    send_receive_1_sm_model_DW.clockTickCounter_b++;
  }
...
static void send_receive_1_sm_model_update(void)
{
...
void send_receive_1_sm_model_initialize(void)
{
...
{
  send_receive_1_sm_model_output();
...
{
  send_receive_1_sm_model_update();
...
void MdlStart(void)
{
  send_receive_1_sm_model_initialize();
}
...
RT_MODEL_send_receive_1_sm_model_T *send_receive_1_sm_model(void)
{
  /* Registration code */
  ...
  (void) memset((void *)send_receive_1_sm_model_M, 0,
                sizeof(RT_MODEL_send_receive_1_sm_model_T));
...

  {
    ...
    send_receive_1_sm_model_B.PulseGenerator = 0.0;
  ...
  /* states (dwork) */
  send_receive_1_sm_model_M->ModelData.dwork = ((void *)
    &send_receive_1_sm_model_DW);
  (void) memset((void *)&send_receive_1_sm_model_DW, 0,
                sizeof(DW_send_receive_1_sm_model_T));
  send_receive_1_sm_model_DW.SFunction_PreviousInput = 0.0;
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: send_receive_1_sm_model/<S5>/S-Function2 (sfun_send_async) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 1 */
        {
          ...
          sfcnUPtrs[0] = send_receive_1_sm_model_P.constants_Value;
          sfcnUPtrs[1] = &send_receive_1_sm_model_P.constants_Value[1];
          sfcnUPtrs[2] = &send_receive_1_sm_model_P.constants_Value[2];
          sfcnUPtrs[3] = &send_receive_1_sm_model_P.constants_Value[3];
          sfcnUPtrs[4] = &send_receive_1_sm_model_B.PulseGenerator;
      ...
      /* work vectors */
      ssSetPWork(rts, (void **) &send_receive_1_sm_model_DW.SFunction2_PWORK);

      {
        ...
        ssSetDWork(rts, 0, &send_receive_1_sm_model_DW.SFunction2_PWORK);
      }
    ...
    /* Level2 S-Function Block: send_receive_1_sm_model/<S3>/S-Function1 (sfun_recv_async) */
    {
      ...
      /* work vectors */
      ssSetPWork(rts, (void **) &send_receive_1_sm_model_DW.SFunction1_PWORK);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_POINTER);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &send_receive_1_sm_model_DW.SFunction1_PWORK);
      }
    ...
    /* Level2 S-Function Block: send_receive_1_sm_model/<S7>/S-Function (OP_SEND) */
    {
      ...
      /* inputs */
      {
        ...
        /* port 0 */
        {
...

          {
            ...
            sfcnUPtrs[8] = send_receive_1_sm_model_P.constants_Value;
            sfcnUPtrs[9] = &send_receive_1_sm_model_P.constants_Value[1];
            sfcnUPtrs[10] = &send_receive_1_sm_model_P.constants_Value[2];
            sfcnUPtrs[11] = &send_receive_1_sm_model_P.constants_Value[3];
            sfcnUPtrs[12] = &send_receive_1_sm_model_B.PulseGenerator;
          }
      ...
      /* work vectors */
      ssSetIWork(rts, (int_T *) &send_receive_1_sm_model_DW.SFunction_IWORK[0]);

      {
        ...
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &send_receive_1_sm_model_DW.SFunction_IWORK[0]);
      }
    ...
    /* Level2 S-Function Block: send_receive_1_sm_model/<S2>/OpIPSocketCtrl1 (sfun_gen_async_ctrl) */
    {
      ...
      /* work vectors */
      ssSetPWork(rts, (void **)
                 &send_receive_1_sm_model_DW.OpIPSocketCtrl1_PWORK);

      {
        ...
        ssSetDWorkDataType(rts, 0,SS_POINTER);
        ssSetDWorkComplexSignal(rts, 0, 0);
        ssSetDWork(rts, 0, &send_receive_1_sm_model_DW.OpIPSocketCtrl1_PWORK);
      }
