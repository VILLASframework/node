...
class PhaseEstimateHook : public SingleSignalHook {
...
public:
	PhaseEstimateHook(Path *p, Node *n, int fl, int prio, bool en = true) :
...
/* Register hook */
static char n[] = "phase_estimate";
static char d[] = "Estimate the phase between a pulse and sine signal";
static HookPlugin<PhaseEstimateHook, n, d, (int) Hook::Flags::NODE_READ | (int) Hook::Flags::NODE_WRITE | (int) Hook::Flags::PATH> p;
