...
template <typename T> JanssonFormatArg makeJanssonFormatArg() = delete;

template <> consteval JanssonFormatArg makeJanssonFormatArg<char const>() {
...
template <> consteval JanssonFormatArg makeJanssonFormatArg<size_t>() {
  return JanssonFormatArg::SIZE;
}

template <> consteval JanssonFormatArg makeJanssonFormatArg<int>() {
  return JanssonFormatArg::INT;
}

template <> consteval JanssonFormatArg makeJanssonFormatArg<unsigned int>() {
  return JanssonFormatArg::INT;
}

template <> consteval JanssonFormatArg makeJanssonFormatArg<json_int_t>() {
  return JanssonFormatArg::JSON_INT;
}

template <>
consteval JanssonFormatArg makeJanssonFormatArg<unsigned json_int_t>() {
  return JanssonFormatArg::JSON_INT;
}

template <> consteval JanssonFormatArg makeJanssonFormatArg<double>() {
  return JanssonFormatArg::DOUBLE;
}

template <> consteval JanssonFormatArg makeJanssonFormatArg<json_t *>() {
