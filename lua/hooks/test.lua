...
SampleFlags = {
	HAS_TS_ORIGIN   = 1,          -- "(1 <<  0)"    Include origin timestamp in output.
	HAS_TS_RECEIVED = 2,          -- "(1 <<  1)"    Include receive timestamp in output.
	HAS_OFFSET      = 4,          -- "(1 <<  2)"    Include offset (received - origin timestamp) in output.
	HAS_SEQUENCE    = 8,          -- "(1 <<  3)"    Include sequence number in output.
	HAS_DATA        = 16,         -- "(1 <<  4)"    Include values in output.

	NEW_FRAME       = 65536,      -- "(1 << 16)"    This sample is the first of a new frame
	NEW_SIMULATION  = 131072,     -- "(1 << 17)"    This sample is the first of a new simulation case
